...
INSERT INTO `manutencao` VALUES (1,'Servidor Principal',90,'2025-11-10','Hardware','Substituição de módulos de memória RAM.','Carlos Eduardo'),(2,'Impressora Laser B',45,'2025-11-10','Escritorio','Troca de fusor e limpeza interna.','Ana Paula'),(3,'Estação de Trabalho 15',20,'2025-11-11','Hardware','Otimização de sistema operacional e drivers.','Felipe Silva'),(4,'Máquina de Corte CNC',180,'2025-11-12','Producao','Calibração dos eixos X e Y. Manutenção preventiva.','Mariana Torres'),(5,'Ar Condicionado Sala A',60,'2025-11-12','Infraestrutura','Limpeza e recarga de gás refrigerante.','Carlos Eduardo');
...
-- Dump completed on 2025-12-02 19:24:06
